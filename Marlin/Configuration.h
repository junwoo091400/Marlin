...
#define STRING_CONFIG_H_AUTHOR "(Khalil Nurullah, 3KU Delta)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3KU Delta"
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // 3ku Delta - stockend w/full fan speed 10/27/17 (M303 S205 C5)
  #define DEFAULT_Kp 21.04
  #define DEFAULT_Ki 1.24
  #define DEFAULT_Kd 89.65
  // Ultimaker
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 98.0 // mm
  ...
  #define DELTA_RADIUS 70.0 //mm  Get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 110.34 }  // for 3ku Delta
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4000, 4000, 4000, 3000 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 0     // X offset: -left  +right  [of the nozzle] nozzle is probe 3ku
...
#define HOMING_FEEDRATE_Z  (75*60) // default marlin 200*60, I liked 50*60, trying 75*60
